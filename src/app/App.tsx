...
const sugestoesData: {id:number;titulo:string;votos:number;status:string;descricao:string;autor:string;data:string}[] = [];

const glossaryTerms: {term:string;def:string;cat:string}[] = [];
...
const gptsData: {id:number;nome:string;autora:string;desc:string;cat:string;icon:ElementType;cor:string;conversas:string;link:string}[] = [];

const gptsCategorias = ["Todos", "Análise", "Metodologia", "Escrita"];

// ─── DATA: PROMPTS ─────────────────────────────────────────────────────────

const promptsData: {id:number;titulo:string;cat:string;desc:string;prompt:string;autor:string;favoritos:number;cor:string}[] = [];
...
const consultoriaGPTs: {nome:string;desc:string;url:string;cor:string;tags:string[];icone:ElementType}[] = [];

const consultoriaAulas: {titulo:string;duracao:string;desc:string;thumb:string}[] = [];

const consultoriaPrompts: {titulo:string;desc:string;categoria:string;cor:string;bordaCor:string}[] = [];
